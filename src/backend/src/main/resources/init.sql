...
create table available_slot (id bigint  not null AUTO_INCREMENT, from_timestamp datetime, scheduled bit default 0, to_timestamp datetime, interviewer_id bigint,active bit default 1, primary key (id)) engine=MyISAM;
...
create table employee (id bigint not null AUTO_INCREMENT, email varchar(255), name varchar(255), phone_number varchar(255), wissen_id varchar(255), active bit default 0, primary key (id)) engine=MyISAM;
